...
namespace ZamenisHealth.HistoriasClinicas
{
    public partial class Historia_NotaEnfermeria : Forma
    {
        ...
        private static readonly IMedicinaGeneral repoMedicinaGeneral = new MMedicinaGeneral();
        private static readonly IConfSystem repoConfSystem = new MConfSystem();
        private static readonly IEncuestasSatis repoEncuestasSatis = new MEncuestasSatis();
        private static readonly ICondiciones repoCond = new MCondiciones();

        public int Admision;
        DateTime Fecha_Serv;
        int Paciente, Cia, Ase, Prof, Valor;
        string CUP, TSERV, Reg_RIP, CMANTID, CMANID, Serv, PACSAL;
        bool Mayus;
        ...
        private void textBox6_Click(object sender, EventArgs e)
        {
            try
            {
                Medicina.CIE10 CIE10_Historias = new Medicina.CIE10("DX1_Nota");
        ...
        private void toolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            Historia_Notas_Plantilla.Tipo_Plant = "Notas";
        ...
        private void Historia_NotaEnfermeria_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Este paciente es un control de mitad de paquete de Alta Complejidad", "Observacion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void textBox8_Click(object sender, EventArgs e)
        {
            try
            {
                Medicina.CIE10 CIE10_Historias = new Medicina.CIE10("DX2_Nota");
                CIE10_Historias.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void textBox9_Click(object sender, EventArgs e)
        {
            try
            {
                Medicina.CIE10 CIE10_Historias = new Medicina.CIE10("DX3_Nota");
                CIE10_Historias.ShowDialog();
            }
            catch (Exception ex)
            {
