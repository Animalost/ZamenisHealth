...
{
    public class MConsolidadoGeneral : IConsolidadoGeneral
    {
                                                       ...
                                                       int Paciente)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(getData["Conexion"]))
                {
                    ...
                    String Primera = "SELECT TOP 1 ResultadoP19, ResultadoP3 " +
                                     "FROM FIB_ENCUESTA2 " +
                    ...
                    {
                        String Ultima = "SELECT TOP 1 ResultadoP19, ResultadoP3 " +
                                        "FROM FIB_ENCUESTA2 " +
                                        "WHERE FechaEncuesta BETWEEN '" + Convert.ToDateTime(desde).ToString("yyyy-MM-dd") + "' AND '" + Convert.ToDateTime(hasta).ToString("yyyy-MM-dd") + "' " +
                                        "AND Estado = 'V' " +
                                        "AND IdPaciente = '" + Paciente + "' " +
                        ...
                        {
                            return (Convert.ToInt32(Lectura_Hora2["ResultadoP19"]),
                                    Convert.ToInt32(Lectura_Hora["ResultadoP19"]),
                                    Convert.ToInt32(Lectura_Hora2["ResultadoP3"]),
                                    Convert.ToInt32(Lectura_Hora["ResultadoP3"]));
                        }
                        else
                        {
                            return (Convert.ToInt32(Lectura_Hora2["ResultadoP19"]), 0, 0, 0);
                        }
                    }
                    else
                    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(getData["Conexion"]))
                {
                    ...
                    if (Lectura_Hora2.Read() == true)
                    {
                        ...
                        var gerResWPI = getTotalWPIbyPac(desde, hasta, Paciente);
                        ...
                        if (Lectura_Hora.Read() == true)
                        {
                            ...
                            R.Add(new E1RespuestasPorcentual
                            {
                                ...
                                IdPac = Paciente,
                                Res1WPI = gerResWPI.Res1D19,
                                Res2WPI = gerResWPI.Res2D19,
                                Res1FSTWPI = gerResWPI.Res1FST3,
                                Res2FSTWPI = gerResWPI.Res2FST3,
                                Logo = bytes,
