...
{
    public class MConsolidadoSF36Porcentual : IConsolidadoSF36Porcentual
    {
        private static readonly ICompañia repositorioCompañia = new MCompañia();

        List<E1RespuestasPorcentual> R = new List<E1RespuestasPorcentual>();
        ...
        public class E1RespuestasPorcentual
        {
            ...
            public int Res1WPI { get; set; }
            public int Res2WPI { get; set; }
            public int Res1FSTWPI { get; set; }
            public int Res2FSTWPI { get; set; }
                ...
                using (SqlConnection con = new SqlConnection(getData["Conexion"]))
                {
                    ...
                    if (Lectura_Hora2.Read() == true)
                    {
                        ...
                        if (Lectura_Hora.Read() == true)
                        {
                            ...
                            double RESFINALFIQ = OP - OPE1;

                            R.Add(new E1RespuestasPorcentual
                            {
                                FIQ1 = OP,
                                D1111 = OP2,
                                D1121 = OP3,
        ...
        int contarAplicaciones(DateTime Desde, DateTime Hasta, int IdPaciente)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(getData["Conexion"]))
                {
                    ...
                    String Query = "SELECT COUNT(IdPaciente) AS Cantidad  " +
                                   "FROM FIB_ENCUESTA1 " +
                                   "WHERE FIB_ENCUESTA1.FechaEncuesta BETWEEN '" + Convert.ToDateTime(Desde).ToString("yyyy-MM-dd") + "' AND '" + Convert.ToDateTime(Hasta).ToString("yyyy-MM-dd") + "' " +
                                   "AND Estado = 'V' " +
                    ...
                    if (Lectura_Hora2.Read() == true)
                    {
                        return Convert.ToInt32(Lectura_Hora2["Cantidad"]);
                    }
                    else
                    {
                        return 0;
        ...
        List<CSF36_1> IConsolidadoSF36Porcentual.getInformeRDLC(DateTime Desde, DateTime Hasta)
        {
            try
            {
                ...
                var getIdsE1 = getIdPacientePorcentual(Desde, Hasta, "E1");
                if (getIdsE1 == null)
                {
                    return (null);
                }

                var getIdsE2 = getIdPacientePorcentual(Desde, Hasta, "E2");
                if (getIdsE2 == null)
                {
                    return (null);
                }
                ...
                {
                    var dicResE1 = getResultPacE1Porcentual(Desde, Hasta, datosE1); //llenar lista global de rsultaos
                }
                ...
                List<CSF36_1> Retorno = new List<CSF36_1>();

                foreach (var discrimina in R)
                {
                    if (discrimina.ResultadoFIQTotal <= -20)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 1,
                            Rango = "Menor a - 20 %",
                            Cuestionario = "1. CUESTIONARIO SOBRE EL IMPACTO DE LA FIBROMIALGIA",
                            Indicador = "1. RESULTADO FIQ",
                            FIQ1 = discrimina.FIQ1,
                            D1111 = discrimina.D1111,
                            D1121 = discrimina.D1121,
                            D1131 = discrimina.D1131,
                            D1141 = discrimina.D1141,
                            D1151 = discrimina.D1151,
                            D1161 = discrimina.D1161,
                            D1171 = discrimina.D1171,
                            D1181 = discrimina.D1181,
                            Promedio81 = discrimina.Promedio81,
                            promedioEmocional1 = discrimina.promedioEmocional1,
                            promedioFisico1 = discrimina.promedioFisico1,
                            paciente = discrimina.paciente,
                            FIQ2 = discrimina.FIQ2,
                            D1112 = discrimina.D1112,
                            D1122 = discrimina.D1122,
                            D1132 = discrimina.D1132,
                            D1142 = discrimina.D1142,
                            D1152 = discrimina.D1152,
                            D1162 = discrimina.D1162,
                            D1172 = discrimina.D1172,
                            D1182 = discrimina.D1182,
                            Promedio82 = discrimina.Promedio82,
                            promedioEmocional2 = discrimina.promedioEmocional2,
                            promedioFisico2 = discrimina.promedioFisico2,
                            ResultadoFIQTotal = discrimina.ResultadoFIQTotal,
                            NumAplicaciones = contarAplicaciones(Desde, Hasta, discrimina.IdPac),
                            Desde = Convert.ToDateTime(Desde),
                            Hasta = Convert.ToDateTime(Hasta),
                            Logo = bytes
                        });
                    }
                    else if (discrimina.ResultadoFIQTotal < -19)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 2,
                    ...
                    else if (discrimina.ResultadoFIQTotal < -9)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 3,
                    ...
                    else if (discrimina.ResultadoFIQTotal == 0)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 4,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 10)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 5,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 20)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 6,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 30)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 7,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 40)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 8,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 50)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 9,
                    ...
                    else if (discrimina.ResultadoFIQTotal <= 60)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 10,
                    ...
                    else if (discrimina.ResultadoFIQTotal > 61)
                    {
                        Retorno.Add(new CSF36_1
                        {
                            ListaPosision = 11,
                ...
                //var ordenada = Retorno.OrderBy(ListaPosision => ListaPosision).ToList();
