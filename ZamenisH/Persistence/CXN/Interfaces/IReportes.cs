...
namespace Persistence.CXN.Interfaces
{
    public interface IReportes
    {
        ...
        List<CXN_HORARIO> BuscarHistorias(string Tipo, string TID, string NID);
        List<HCMG> MedicinaGeneral(int Admision);
        List<HCMG> MedicinaGeneralCompleto(int PacienteHCCompleto, DateTime FechaHC, string userGenera);
        ...
        List<ReportEVO> ReporteEvoluciones(string TID,
                                           string ID,
                                           DateTime Desde,
                                           DateTime Hasta,
                                           string Tipo_Evo_Rep);
        ...
        List<EpicrisisReport> ReporteEpicrisis(string TID, string NID, DateTime Desde, DateTime Hasta);
        ...
        List<FacturacionReports> GetListOtrasFacturas(DateTime Desde,
                                                      DateTime Hasta,
                                                      int Cia,
                                                      int Ase);
